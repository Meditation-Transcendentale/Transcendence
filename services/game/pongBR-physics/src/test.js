...
// Run both benchmarks
runBenchmark(PhysicsBR, 'PhysicsBR (Data-Oriented)', { playerCount: 50, ballCount: 200, ticks: 600 });
runBenchmark(LegacyPhysics, 'Legacy Physics (OOP)', { playerCount: 50, ballCount: 200, ticks: 600 });
