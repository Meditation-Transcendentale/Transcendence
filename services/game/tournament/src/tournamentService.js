...
class Tournament {
  constructor(id, playerIds, uwsApp) {
    ...
    natsClient.subscribe("games.tournament.*.match.end", (data, msg) => {
      ...
      match.setResult(decoded, this.players);
...
export default class tournamentService {
  ...
  async ready(ws, tournamentId, playerId) {
    ...
    console.log(`is ready active:${t.readyActive}`);
    console.log(
      `are all non eliminated players ready:${t.allNonEliminatedPlayersReady()}`
    );
