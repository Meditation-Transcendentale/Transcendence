...
export function encodeTournamentCreateRequest(payload) {
  ...
  if (err) throw new Error(err);
  return Proto.tournament.TournamentCreateRequest.encode(
    Proto.tournament.TournamentCreateRequest.create(payload)
  ).finish();
}
...
export function encodeTournamentCreateResponse(payload) {
  ...
  if (err) throw new Error(err);
  return Proto.tournament.TournamentCreateResponse.encode(
    Proto.tournament.TournamentCreateResponse.create(payload)
  ).finish();
}
...
export function encodeTournamentServerMessage(payload) {
  ...
  if (err) throw new Error(err);
  return Proto.tournament.TournamentServerMessage.encode(
    Proto.tournament.TournamentServerMessage.create(payload)
  ).finish();
}
...
export function encodeServerMessage(payload) {
  ...
  if (err) throw new Error(err);
  return Proto.lobby.ServerMessage.encode(
    Proto.lobby.ServerMessage.create(payload)
  ).finish();
}
...
export function encodeStatusUpdate(payload) {
  ...
  if (err) throw new Error(err);
  return Proto.notif.StatusUpdate.encode(
    Proto.notif.StatusUpdate.create(payload)
  ).finish();
}
...
export function encodeTournamentClientMessage(payload) {
  ...
  if (err) throw new Error(err);
  return Proto.tournament.TournamentClientMessage.encode(
    Proto.tournament.TournamentClientMessage.create(payload)
  ).finish();
}
